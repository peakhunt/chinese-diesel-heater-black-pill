...
button_handler(gpio_in_pin_t pin, gpio_input_state_t state, void* arg)
{
  ...
  case gpio_in_pin_pb3:   // select button
    input = display_input_select;
    break;

  case gpio_in_pin_pb4:   // up button
    input = display_input_up;
    break;

  case gpio_in_pin_pb5:   // down button
...
display_init(void)
{
  ...
  gpio_listen(gpio_in_pin_pb5, button_handler, NULL);
